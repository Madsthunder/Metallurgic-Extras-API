...
{
	public static final ResourceLocation ORETYPE_TO_IBLOCKSTATE = new ResourceLocation("metalextras",
			"oretype_to_iblockstate");
	...
	public static void registerMaterialSmeltingRecipe(OreMaterial material, ItemStack ingot, float xp,
							...
							for (int j2 = l; j2 <= k1; ++j2)
							{
								...
								if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
								{
									...
									if (properties.canSpawnAtCoords(world, blockpos)
											&& state.getBlock().isReplaceableOreGen(state, world, blockpos, properties))
									{
