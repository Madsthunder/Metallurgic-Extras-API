...
public class OreUtils
{
	...
	public static boolean generateOres(World world, BlockPos pos, Random random, int blocks, OreProperties properties)
	{
		  ...
		  d9 + 1.0D; int j = MathHelper.floor(d6 - d10 / 2.0D); int k =
		  MathHelper.floor(d7 - d11 / 2.0D); int l =
		  MathHelper.floor(d8 - d10 / 2.0D); int i1 =
		  MathHelper.floor(d6 + d10 / 2.0D); int j1 =
		  MathHelper.floor(d7 + d11 / 2.0D); int k1 =
		  MathHelper.floor(d8 + d10 / 2.0D);
